...
def seed_db():
    db.session.add(
        Participant(name="jengroff", email="josh@marchingant.com", phone="+19172975952")
    )
    db.session.add(
        Participant(
            name="joshengroff", email="josh.engroff@gmail.com", phone="+19172975952"
        )
    )
    db.session.add(
        Screener(
            prospect_name="Bilbo Baggins",
